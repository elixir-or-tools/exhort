...
extern "C"
{
  ...
  static ErlNifFunc nif_funcs[] = {
      ...
      {"add_greater_or_equal_constant_nif", 3, add_greater_or_equal_constant_nif},
      ...
      {"add_less_or_equal_constant_nif", 3, add_less_or_equal_constant_nif},
      {"add_lin_expr_less_or_equal_constant_nif", 3, add_lin_expr_less_or_equal_constant_nif},
      {"add_constant_less_or_equal_lin_expr_nif", 3, add_constant_less_or_equal_lin_expr_nif},
